    ...
    <>
      <div className="mt-40 w-full flex justify-between items-center px-10 md:px-80">
        ...
        <div className="flex items-center justify-center">
          <div className="physical nonconstrained circle rounded-full h-16 w-16 bg-white cursor-grab active:cursor-grabbing border-2 border-transparent hover:border-white"></div>
        </div>

        {/* Right Side: The Pyramid */}
